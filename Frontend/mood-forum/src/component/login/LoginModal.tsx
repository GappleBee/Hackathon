function LoginModal() {
  ...
  return (
    <div className="relative flex flex-col rounded-[8px] items-center p-[60px] gap-[24px] self-stretch border-solid w-[535px] h-auto bg-white">
      ...
      <div className="w-[415px] h-[88px] flex flex-col justify-between">
        <span className="text-[14px] font-[600] leading-[24px] font-poppins">Email or Username</span><br/>
        <input className="bg-[#D9D9D9] text-[#575A5C] w-[415px] h-[56px] rounded-[8px] py-[16px] pl-[19px]" type="text" placeholder="example@yourdomain.com"/>
      </div>
      <div className="w-[415px] h-[88px] flex flex-col justify-between">
        <span className="text-[14px] font-[600] leading-[24px] font-poppins">Password</span><br/>
        <span className="flex border-2w-[415px] h-[56px]">
          <input className="bg-[#D9D9D9] text-[#575A5C] w-full rounded-tl-[8px] rounded-bl-[8px] py-[16px] pl-[19px]" type="text" placeholder="Enter your password"/>
      ...
      <div className="bg-[#E2F266] h-[56px] flex justify-center items-center gap-[10px] self-stretch rounded-[8px]">
        <button className="font-poppins">Log In</button>
      </div>
      <div className="w-[414px] h-6 relative ">
        <div className="left-[255px] top-0 absolute text-right text-[#148ee6] text-sm font-normal font-['Poppins'] leading-normal">Forgot Your Password?</div>
        ...
        <div className="left-[148px] top-0 absolute text-right text-[#148ee6] text-sm font-normal font-['Poppins'] leading-normal">Sign Up</div>
    </div>
    </div>
