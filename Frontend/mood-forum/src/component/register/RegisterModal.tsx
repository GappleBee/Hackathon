    ...
    return (
      <form onSubmit={handleSubmit(onLogin)} className="relative flex flex-col rounded-[8px] items-center p-[60px] gap-[24px] self-stretch border-solid w-[535px] h-auto bg-white">
        <div className="w-[420px] text-center">
          <h1 className="text-[#212426] text-[36px] not-italic font-[600] leading-[52px] font-poppins">Create an account</h1>
          <span className="whitespace-nowrap text-[#212426] text-[18px] not-italic font-[400] leading-[22px] font-poppins">It’s a pleasure to have you join the community!</span>
        </div>
        <div className="w-[415px] flex flex-col justify-between">
          <span className="text-[14px] font-[600] leading-[24px] font-poppins mb-1 ml-4">Username</span><br/>
          <input {...register("username", usernameValidate)} className="bg-[#D9D9D9] text-[#575A5C] outline-none w-[415px] h-[56px] rounded-[8px] py-[16px] pl-[19px]" type="text" placeholder="John Doe"/>
        ...
        <div className="w-[415px] flex flex-col justify-between">
          <span className="text-[14px] font-[600] leading-[24px] font-poppins mb-1 ml-4">Email</span><br/>
          <input {...register("email", emailValidate)} className="bg-[#D9D9D9] text-[#575A5C] outline-none w-[415px] h-[56px] rounded-[8px] py-[16px] pl-[19px]" type="text" placeholder="example@yourdomain.com"/>
          <span className="text-[14px] font-[400] leading-[24px] font-poppins text-[#F34735]">{ errors.email && (<span className='ml-4'>{ errors.email.message }</span>) }</span>
        </div>
        <div className="w-[415px] flex flex-col justify-between">
        ...
        <div className="font-poppins font-[400] text-[12px] leading-[16px] text-center w-[248px]">
            By registering, you agree to Sentimentia's <span className='text-[#148EE7] hover:cursor-pointer'>Terms of Service</span> and our <span className='text-[#148EE7] hover:cursor-pointer'>Privacy Policy</span>
        </div>
      </form>
    )
}
